...
const menuItems = [
    ...
    },
    {
        ...
        to: "/admin/export",
        icon: (
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v8m4-4H8m13 0a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
        ),
    },
    {
        label: "Người dùng",
...
export default function AdminSidebar() {
    return (
        <aside className="w-72 bg-white border-r hidden md:flex flex-col shrink-0 h-screen sticky top-0 overflow-y-auto">
            {/* Logo */}
            ...
            <nav className="flex-1 mt-4 text-sm">
               ...
               ${isActive
                                ? "bg-purple-50 text-purple-700 border-r-4 border-purple-700 font-bold"
