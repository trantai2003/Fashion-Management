...
export default function AuthPage() {
    ...
    const validateRegister = () => {
        ...
        if (registerData.tenDangNhap.length < 6 || registerData.tenDangNhap.length > 50) {
        ...
        if (registerData.hoTen.length < 6 || registerData.hoTen.length > 100) {
        ...
        if (registerData.soDienThoai.length < 10 || registerData.soDienThoai.length > 11) {
    ...
    const handleGoogleLogin = () => {
        ...
        // TODO: Nối API Google OAuth
    };

    const handleFacebookLogin = () => {
        console.log('Đăng nhập với Facebook');
        // TODO: Nối API Facebook OAuth
    };
                                ...
                                <div className="space-y-4">
                                    <div className="space-y-2">
                                        ...
                                        {errors.tenDangNhap && (
                                            <Alert variant="destructive" className="py-2">
                                                <AlertCircle className="h-4 w-4" />
                                                <AlertDescription className="text-sm">{errors.tenDangNhap}</AlertDescription>
                                            </Alert>
                                        )}
                                    </div>
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        {errors.hoTen && (
                                            <Alert variant="destructive" className="py-2">
                                                <AlertCircle className="h-4 w-4" />
                                                <AlertDescription className="text-sm">{errors.hoTen}</AlertDescription>
                                            </Alert>
                                        )}
                                    </div>
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        {errors.soDienThoai && (
                                            <Alert variant="destructive" className="py-2">
                                                <AlertCircle className="h-4 w-4" />
                                                <AlertDescription className="text-sm">{errors.soDienThoai}</AlertDescription>
                                            </Alert>
                                        )}
                                    </div>
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        {errors.matKhau && (
                                            <Alert variant="destructive" className="py-2">
                                                <AlertCircle className="h-4 w-4" />
                                                <AlertDescription className="text-sm">{errors.matKhau}</AlertDescription>
                                            </Alert>
                                        )}
                                    </div>
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        {errors.xacNhanMatKhau && (
                                            <Alert variant="destructive" className="py-2">
                                                <AlertCircle className="h-4 w-4" />
                                                <AlertDescription className="text-sm">{errors.xacNhanMatKhau}</AlertDescription>
                                            </Alert>
                                        )}
                                    </div>
