...
export default function DonBanHangInvoice() {
        ...
        return (
            <div className="min-h-screen bg-[#faf8f3] flex items-center justify-center print:hidden">
                <div className="flex flex-col items-center gap-4">
                    ...
                    <p className="text-[#a89f92] font-mono text-xs uppercase tracking-widest">Đang tải hóa đơn...</p>
                </div>
            </div>
        );
    }
    ...
    return (
        <>
            <style>{STYLES}</style>
            <div className="wh-root print:bg-white print:p-0">
                ...
                <div className="wh-inner print:block">
                    ...
                    <div id="invoice-area" className="print-area max-w-4xl mx-auto bg-white p-12 rounded-2xl border border-[rgba(184,134,11,0.15)] shadow-[0_2px_20px_rgba(100,80,30,0.05)] text-[#1a1612]">
                        ...
                        <div className="mb-10 text-center relative">
                            <h1 className="text-3xl font-black font-['Playfair_Display'] text-[#1a1612] tracking-wide mb-2">HÓA ĐƠN BÁN HÀNG</h1>
                            <p className="text-sm text-[#7a6e5f] font-mono uppercase tracking-wider">Mã đơn: <span className="text-[#b8860b] font-bold">{donBanHang.soDonHang}</span></p>
                        ...
                        <div className="grid grid-cols-2 gap-8 mb-10 text-[15px] leading-relaxed">
                            <div className="p-5 bg-[#faf8f3] rounded-xl border border-[rgba(184,134,11,0.1)]">
                                <p className="font-mono text-xs font-bold text-[#b8860b] uppercase tracking-widest mb-2">Bên bán</p>
                            ...
                            <div className="p-5 bg-[#faf8f3] rounded-xl border border-[rgba(184,134,11,0.1)]">
                                <p className="font-mono text-xs font-bold text-[#b8860b] uppercase tracking-widest mb-2">Bên mua</p>
                            ...
                            <table className="w-full text-sm text-left border-collapse">
                                <thead>
                                    <tr className="bg-[#faf8f3] border-b border-[#e5dfd3]">
                                        ...
                                        <th className="px-4 py-3 font-mono text-xs font-bold text-[#7a6e5f] uppercase tracking-wider">Sản phẩm</th>
                        ...
                        {/* Chữ ký */}
                        <div className="mt-16 pt-8 text-[15px] grid grid-cols-2">
                            <div className="text-center">
                                <p className="font-bold uppercase tracking-wider mb-1">Người lập</p>
                            ...
                            <div className="text-center">
                                <p className="font-bold uppercase tracking-wider mb-1">Đại diện khách hàng</p>
                                <p className="text-xs text-[#7a6e5f] italic">(Ký và ghi rõ họ tên)</p>
                                <div className="h-24" />
                                <p className="font-bold text-[#1a1612]">{donBanHang.khachHang.tenKhachHang}</p>
                            </div>
                        </div>
                    </div>
                </div>
